...
public class Market {
    ...
    public static HashMap<String, ArrayList<Integer>> buyAction(
            HashMap<Items, Integer> purchaseTable, HashMap<String, ArrayList<Integer>> playerCargo)
    {
    ...
    public static HashMap<String, ArrayList<Integer>> buyAction2(
            HashMap<Items, Integer> purchaseTable, HashMap<String, ArrayList<Integer>> planetCargo)
    {
    ...
    public static HashMap<Items, int[]> sellAction(
            HashMap<Items, Integer> purchaseTable, HashMap<Items, int[]> planetCargo) {
    ...
    public static HashMap<Items, int[]> sellAction2(
            HashMap<Items, Integer> purchaseTable, HashMap<Items, int[]> playerCargo) {
        ...
        for (int i = 0; i < items.length; i++) {
            if (purchaseTable.get(items[i]) != null) {
                ...
                newCargo.put(items[i], new int[] {
                        playerCargo.get(items[i])[0], playerCargo.get(items[i])[1]});
