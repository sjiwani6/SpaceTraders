...
//        stub.setLayoutResource(R.layout.content_buy);
    ...
    public void onSellPressed(View view) {
        ...
        waterField.setText("0/"+ playerCargo.get(Items.WATER)[0]);
        fursField.setText("0/"+ playerCargo.get(Items.FURS)[0]);
        foodField.setText("0/"+ playerCargo.get(Items.FOOD)[0]);
        oreField.setText("0/"+ playerCargo.get(Items.ORE)[0]);
        gameField.setText("0/"+ playerCargo.get(Items.GAMES)[0]);
        fireField.setText("0/"+ playerCargo.get(Items.FIREARMS)[0]);
        medField.setText("0/"+ playerCargo.get(Items.MEDICINE)[0]);
        machField.setText("0/"+ playerCargo.get(Items.MACHINES)[0]);
...
//        stub.setLayoutResource(R.layout.content_sell);
    ...
    public void onItemButton(View view) {
        ...
        int totalCount = Integer.parseInt(""+totalField.getText().toString().substring(0, totalField.getText().toString().indexOf("/")));

        String count;
        int totalCR = Integer.parseInt(totalPrice.getText().toString().substring(0, totalPrice.getText().toString().indexOf("C")));
        ...
        if (id == R.id.water_plus) {
            ...
            price = planetCargo.get(Items.WATER)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.WATER)[0]
                && (remainingCr - totalCR - price) > 0) {
                waterField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.WATER)[0]);
        ...
        if (id == R.id.furs_plus) {
            ...
            price = planetCargo.get(Items.FURS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.FURS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                fursField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.FURS)[0]);
        ...
        if (id == R.id.food_plus) {
            ...
            price = planetCargo.get(Items.FOOD)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.FOOD)[0]
                    && (remainingCr - totalCR - price) > 0) {
                foodField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.FOOD)[0]);
        ...
        if (id == R.id.ore_plus) {
            ...
            price = planetCargo.get(Items.ORE)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.ORE)[0]
                    && (remainingCr - totalCR - price) > 0) {
                oreField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.ORE)[0]);
        ...
        if (id == R.id.game_plus) {
            ...
            price = planetCargo.get(Items.GAMES)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.GAMES)[0]
                    && (remainingCr - totalCR - price) > 0) {
                gameField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.GAMES)[0]);
        ...
        if (id == R.id.fire_plus) {
            ...
            price = planetCargo.get(Items.FIREARMS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.FIREARMS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                fireField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.FIREARMS)[0]);
        ...
        if (id == R.id.med_plus) {
            ...
            price = planetCargo.get(Items.MEDICINE)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.MEDICINE)[0]
                    && (remainingCr - totalCR - price) > 0) {
                medField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.MEDICINE)[0]);
        ...
        if (id == R.id.mach_plus) {
            ...
            price = planetCargo.get(Items.MACHINES)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.MACHINES)[0]
                    && (remainingCr - totalCR - price) > 0) {
                machField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.MACHINES)[0]);
        ...
        if (id == R.id.narc_plus) {
            ...
            price = planetCargo.get(Items.NARCOTICS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.NARCOTICS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                narcField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.NARCOTICS)[0]);
        ...
        if (id == R.id.robo_plus) {
            ...
            price = planetCargo.get(Items.ROBOTS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < planetCargo.get(Items.ROBOTS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                roboField.setText(Integer.parseInt(count) + 1 +"/"+ planetCargo.get(Items.ROBOTS)[0]);
    ...
    public void onItemButton2(View view) {
        ...
        if (id == R.id.water_plus) {
            count = ""+ waterField.getText().toString().substring(0,waterField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.WATER)[1];

            if (totalCount > 0 && Integer.parseInt(count) < playerCargo.get(Items.WATER)[0]
                    && (remainingCr - totalCR - price) > 0) {
                waterField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.WATER)[0]);
                purchaseTable.put(Items.WATER, Integer.parseInt(count) + 1);
                totalField.setText(totalCount - 1 + "/"+capacity);
                totalPrice.setText(totalCR + price + "Cr");
            }
        ...
        if (id == R.id.furs_plus) {
            count = ""+ fursField.getText().toString().substring(0,fursField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.FURS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.FURS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                fursField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.FURS)[0]);
                purchaseTable.put(Items.FURS, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.food_plus) {
            count = ""+ foodField.getText().toString().substring(0,foodField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.FOOD)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.FOOD)[0]
                    && (remainingCr - totalCR - price) > 0) {
                foodField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.FOOD)[0]);
                purchaseTable.put(Items.FOOD, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.ore_plus) {
            count = ""+ oreField.getText().toString().substring(0,oreField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.ORE)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.ORE)[0]
                    && (remainingCr - totalCR - price) > 0) {
                oreField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.ORE)[0]);
                purchaseTable.put(Items.ORE, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.game_plus) {
            count = ""+ gameField.getText().toString().substring(0,gameField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.GAMES)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.GAMES)[0]
                    && (remainingCr - totalCR - price) > 0) {
                gameField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.GAMES)[0]);
                purchaseTable.put(Items.GAMES, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.fire_plus) {
            count = ""+ fireField.getText().toString().substring(0,fireField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.FIREARMS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.FIREARMS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                fireField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.FIREARMS)[0]);
                purchaseTable.put(Items.FIREARMS, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.med_plus) {
            count = ""+ medField.getText().toString().substring(0,medField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.MEDICINE)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.MEDICINE)[0]
                    && (remainingCr - totalCR - price) > 0) {
                medField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.MEDICINE)[0]);
                purchaseTable.put(Items.MEDICINE, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.mach_plus) {
            count = ""+ machField.getText().toString().substring(0,machField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.MACHINES)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.MACHINES)[0]
                    && (remainingCr - totalCR - price) > 0) {
                machField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.MACHINES)[0]);
                purchaseTable.put(Items.MACHINES, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.narc_plus) {
            count = ""+ narcField.getText().toString().substring(0,narcField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.NARCOTICS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.NARCOTICS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                narcField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.NARCOTICS)[0]);
                purchaseTable.put(Items.NARCOTICS, Integer.parseInt(count) + 1);
        ...
        if (id == R.id.robo_plus) {
            count = ""+ roboField.getText().toString().substring(0,roboField.getText().toString().indexOf("/"));
            price = playerCargo.get(Items.ROBOTS)[1];

            if (totalCount < capacity && Integer.parseInt(count) < playerCargo.get(Items.ROBOTS)[0]
                    && (remainingCr - totalCR - price) > 0) {
                roboField.setText(Integer.parseInt(count) + 1 +"/"+ playerCargo.get(Items.ROBOTS)[0]);
                purchaseTable.put(Items.ROBOTS, Integer.parseInt(count) + 1);
